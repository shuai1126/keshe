...
public:
    ...
    void setupUi(QWidget *Menu)
    {
        ...
        pushButton_2->setGeometry(QRect(580, 70, 301, 181));
        QFont font1;
        font1.setPointSize(30);
        pushButton_2->setFont(font1);
        pushButton_3 = new QPushButton(Menu);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(580, 260, 301, 221));
        ...
        pushButton_4->setGeometry(QRect(720, 20, 151, 51));
        pushButton_5 = new QPushButton(Menu);
        pushButton_5->setObjectName(QStringLiteral("pushButton_5"));
        pushButton_5->setGeometry(QRect(0, 0, 113, 32));
    ...
    void retranslateUi(QWidget *Menu)
    {
        ...
        pushButton_5->setText(QApplication::translate("Menu", "PushButton", Q_NULLPTR));
    } // retranslateUi
