...
public:
    ...
    void setupUi(QWidget *DeleteTrain)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(80, 120, 781, 41));
        ...
        horizontalLayoutWidget_2->setGeometry(QRect(80, 180, 781, 41));
        ...
        pushButton->setGeometry(QRect(80, 240, 171, 71));
        pushButton->setFont(font);
        pushButton_2 = new QPushButton(DeleteTrain);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(750, 50, 113, 51));
