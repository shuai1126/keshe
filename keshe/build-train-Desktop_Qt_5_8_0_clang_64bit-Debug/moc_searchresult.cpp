...
#include "../../../Library/Containers/com.tencent.xinWeChat/Data/Library/Application Support/com.tencent.xinWeChat/2.0b4.0.9/7850db43aeaa5346dc20f97ca1c130a0/Message/MessageTemp/6e97833709cc8c084f4e34b7c2f0e3e7/File/guidang/train/searchresult.h"
...
QT_MOC_LITERAL(5, 51, 23) // "on_pushButton_2_clicked"
    ...
    "SearchResult\0display\0\0number\0"
...
void SearchResult::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SearchResult *_t = static_cast<SearchResult *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (SearchResult::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchResult::display)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SearchResult::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SearchResult.data,
      qt_meta_data_SearchResult,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void SearchResult::display(int _t1)
{
