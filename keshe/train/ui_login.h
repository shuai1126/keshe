...
public:
    ...
    void setupUi(QWidget *Login)
    {
        ...
        label->setGeometry(QRect(410, 10, 121, 61));
        QFont font;
        font.setPointSize(40);
        label->setFont(font);
        verticalLayoutWidget = new QWidget(Login);
        verticalLayoutWidget->setObjectName(QStringLiteral("verticalLayoutWidget"));
        verticalLayoutWidget->setGeometry(QRect(250, 80, 421, 161));
        ...
        pushButton->setGeometry(QRect(340, 250, 221, 61));
        QFont font2;
        font2.setPointSize(30);
        pushButton->setFont(font2);
        pushButton_2 = new QPushButton(Login);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(340, 320, 221, 61));
        pushButton_2->setFont(font2);
        pushButton_3 = new QPushButton(Login);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(340, 390, 221, 61));
    ...
    void retranslateUi(QWidget *Login)
    {
        ...
        pushButton_3->setText(QApplication::translate("Login", "\351\207\215\347\275\256", Q_NULLPTR));
    } // retranslateUi
