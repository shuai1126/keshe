...
public:
    ...
    void setupUi(QWidget *ChangeTrain)
    {
        ...
        horizontalLayoutWidget_2->setGeometry(QRect(50, 250, 781, 41));
        ...
        pushButton->setGeometry(QRect(50, 310, 171, 71));
        pushButton->setFont(font);
        horizontalLayoutWidget = new QWidget(ChangeTrain);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(50, 190, 781, 41));
        ...
        label->setGeometry(QRect(50, 110, 171, 61));
        QFont font1;
